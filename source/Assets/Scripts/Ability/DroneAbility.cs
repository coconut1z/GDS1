...
public class DroneAbility : AbilityModule {

    public GameObject newDronePrefab;
	...
	protected override void Start () {
        ...
        escorts = false;
        abilityName = "Summon Drones";
        abilityText.text = abilityName;
        abilityId = Global.DRONE;
	}
    ...
    public override void Activate()
	{
        if (!escorts && cooldownTimer > cooldown && playerController.abilityMeter >= cost) {
            ...
            GetPlayerPos();
            newDrone = Instantiate(newDronePrefab, new Vector3(playerX, playerY), Quaternion.identity);
