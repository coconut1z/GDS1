...
public class HunterDroneIII : MonoBehaviour {
    ...
    public HunterDroneGunIII parentGun;
    private float randomTimer;
    private bool targetOffset;
    //weapon stuff
    public DroneIIIMiniMiniGun fg;
    ...
    void Start () {
        ...
        parentGun = GetComponentInParent<HunterDroneGunIII>();
        fg = GetComponentInChildren<DroneIIIMiniMiniGun>();
        randomTimer = 0.0f;
        targetOffset = false; //doesn't matter if true or false, its here to get flipped.
    }
    ...
    private void Update() {
        ...
        Shoot(); //moar dakka //disabled while testing.
