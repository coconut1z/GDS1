...
public class CompanionDroneI : MonoBehaviour {
    ...
    void Start() {
        ...
        fg = GetComponentInChildren<CompDroneTempFlak>();
        randomTimer = 0;
        targetOffset = false;
        StartHunt();
    }
    ...
    private void EmergencyTP() {
        ...
        //no longer needed due to ship attachment.
        /*
