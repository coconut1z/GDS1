...
public class HunterDroneI : MonoBehaviour {
    ...
    public HunterDroneGunI parentGun;
    //weapon stuff
    public DroneTempFlak fg;
    ...
    void Start() {
        ...
        parentGun = GetComponentInParent<HunterDroneGunI>();
        fg = GetComponentInChildren<DroneTempFlak>();
        randomTimer = 0;
        targetOffset = false;
